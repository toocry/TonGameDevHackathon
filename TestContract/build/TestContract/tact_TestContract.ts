...
export class TestContract implements Contract {
    ...
    static async init(id: bigint) {
        return await TestContract_init(id);
    }
    
    static async fromInit(id: bigint) {
        const init = await TestContract_init(id);
